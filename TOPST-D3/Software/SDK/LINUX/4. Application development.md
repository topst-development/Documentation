...
### 4.1.1 Build Application with Devtool
...
<p align="center"><strong>Figure 4.1 Yocto Devtool Process</strong></p>

<br/>

### 4.1.1.1 BitBake Configuration
...
### 4.1.2.5 Eclipse Software Installation
...
<p align="center"><strong>Figure 4.3 Eclipse Window</strong></p>

2. Select "Luna - http://download.eclipse.org/releases/luna" in Work with:

<p align="center">
    <img src="https://github.com/Topst-Dev/Documentation/assets/144076415/856a0f9b-8c17-443a-957f-0139fea0a953" width="500" height="400">
</p>
<p align="center"><strong>Figure 4.4 Eclipse Software Installation</strong></p>
...
### 4.1.2.6 Yocto Plug-in Installation
...
<p align="center"><strong>Figure 4.5 Eclipse Window</strong></p>
...
<p align="center">
    <img src="https://github.com/Topst-Dev/Documentation/assets/144076415/b320627a-dcef-485d-8893-d20f99d4ccc8" width="700" height="230">
</p>
<p align="center"><strong>Figure 4.6 Add Repository</strong></p>

<p align="center">
    <img src="https://github.com/Topst-Dev/Documentation/assets/144076415/d8d486a8-d33b-4635-ae22-4dc1ae1b28d7" width="700" height="570">
</p>
<p align="center"><strong>Figure 4.7 Eclipse Yocto Installation</strong></p>
...
<p align="center"><strong>Figure 4.8 Select Preferences</strong></p>
...
<p align="center"><strong>Figure 4.9 Preference Settings</strong></p>
...
### 4.1.2.8 Create and Debug Project

<br/>

### 4.1.2.8.1 Create Project
...
<p align="center"><strong>Figure 4.10 Create New Project</strong></p>

<p align="center">
    <img src="https://github.com/Topst-Dev/Documentation/assets/144076415/c60445f3-e4d1-41cf-8fe4-9ebfdd9e979d" width="700" height="600">
</p>
<p align="center"><strong>Figure 4.11 Project Preference</strong></p>
...
<p align="center">
    <img src="https://github.com/Topst-Dev/Documentation/assets/144076415/b91390ab-5a63-4380-94cb-781e28a2db42" width="400" height="600">
</p>
<p align="center"><strong>Figure 4.12 Reconfigure Project</strong></p>

<br/>

### 4.1.2.8.2 Debug Project with TCF

1. Select “Debug Configuration” on the Run tab. You can create a new tab by double-clicking the “C/C++ Remote Application” tab.

<p align="center">
    <img src="https://github.com/Topst-Dev/Documentation/assets/144076415/957dc0bc-3a9e-40bc-8b9f-d1983f96a27c" width="700" height="400">
</p>
<p align="center"><strong>Figure 4.13 Debug Configuration</strong></p>

2. Connect ***Eclipse*** and the board to each other via Ethernet.
3. Select “New” on the “Connection” tab, and select TCF.

<p align="center">
    <img src="https://github.com/Topst-Dev/Documentation/assets/144076415/fe44eec9-d669-4115-8d7a-6d0c1472e386" width="500" height="420">
</p>
<p align="center"><strong>Figure 4.14 Select Target</strong></p>
...
<p align="center">
    <img src="https://github.com/Topst-Dev/Documentation/assets/144076415/5229c9ae-db3d-4544-a1a0-cc52894abf26" width="500" height="450">
</p>
<p align="center"><strong>Figure 4.15 Connect Target Network</strong></p>
...
<p align="center">
    <img src="https://github.com/Topst-Dev/Documentation/assets/144076415/badc573a-f6d3-4576-95f7-09f14f9c408c" width="750" height="70">
</p>
<p align="center"><strong>Figure 4.16 Set Source Path</strong></p>

<p align="center">
    <img src="https://github.com/Topst-Dev/Documentation/assets/144076415/356c0acc-d49f-4311-958f-9fc17df67906" width="750" height="240">
</p>
<p align="center"><strong>Figure 4.17 Success Screen</strong></p>

<p align="center">
    <img src="https://github.com/Topst-Dev/Documentation/assets/144076415/b4a865d5-a72c-4ba3-ad92-cb66709e8d40" width="650" height="300">
</p>
<p align="center"><strong>Figure 4.18 Board Console Screen</strong></p>
...
<p align="center">
    <img src="https://github.com/Topst-Dev/Documentation/assets/144076415/19371066-8a6b-45a0-a8f4-4e0949f7e662" width="850" height="140">
</p>
<p align="center"><strong>Figure 4.19 aplay -l result Screen</strong></p>
...
```
<p align="center">
    <img src="https://github.com/Topst-Dev/Documentation/assets/144076415/4e28ba09-1d4b-4e53-b25f-dc3dc9ab66fd" width="750" height="340">
</p>
<p align="center"><strong>Figure 4.20 speaker-test -c 2 result Screen</strong></p>
...
<p align="center"><strong>Figure 4.21 play ${sample.mp3} result Screen</strong></p>
...
<p align="center"><strong>Figure 4.22 VLC player on TOPST D3</strong></p>
...
<p align="center"><strong>Figure 4.23 GPIO Linux Pin map</strong></p>
...
<p align="center"><strong>Figure 4.24 GPIO Example Board</strong></p>
...
<p align="center"><strong>Figure 4.25 Dot-matrix Test with SPI</strong></p>
