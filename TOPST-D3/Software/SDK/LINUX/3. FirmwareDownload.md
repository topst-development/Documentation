...
## 3.3 Samba Share
1. Go to **Virtual Machine - Setting - Network**

2. Adapter1 is usually sets to NAT, so add a network to Adapter2. Check "Enable Network Adapter" and select Host-only Adapter in the "Attached to" category.
<p align="center"><img src="https://github.com/topst-development/Documentation/assets/161264431/4d2c7113-f38a-4992-a3d2-780bc2ebfeaa"></p>
<p align="center"><strong>Figure 3.4 Setting Virtual machine Network</strong></p>
...
4. Turn on samba service
    ```
    $ sudo systemctl enable smbd
    ```

5. Register your samba password.The writer's Ubuntu account name is topst. You need to write the command with your Ubuntu account name.    
   ```
   $ sudo smbpasswd -a topst
   ```
...
7. Open **smb.conf located at /etc/samba/** and add content to the bottom as shown below.
   ```
   [topst]
...
8. Restart samba server
   ```
   $ sudo /etc/init.d/smbd restart
   ```

9. Open Windows Credentials Management and add the ip(you can check your ip in ubuntu with 'ifconfig') and samba account and password you set up in Ubuntu.
    <p align="center"><img src="https://github.com/topst-development/Documentation/assets/161264431/d3f5253d-056b-4dc4-b174-b2cf4b7a2d62"></p>
    <p align="center"><strong>Figure 3.5 Add Windows Credentials Management</strong></p>

10. Enter **\\192.168.56.~\topst** and Check "**Connect using different credentials**".
    <p align="center"><img src="https://github.com/topst-development/Documentation/assets/161264431/944bf8c2-c6b5-4da1-87d4-3f5364ff8297"></p>
    <p align="center"><strong>Figure 3.6 Setting Network Drive Connections</strong></p>

11. Enter your Credentials Management password.
    <p align="center"><img src="https://github.com/topst-development/Documentation/assets/161264431/55c90321-5ce8-444f-ae26-49fcb4a4f05d"></p>
    <p align="center"><strong>Figure 3.7 Enter your Credentials Management password</strong></p>
...
2. Move "output.fwdn.win.zip" to Windows environment and unzip "output.fwdn.zip".
3. Excute Powershell and go to output.fwdn.win/.

    “fwdn.bat” is an executable file that enables automatic firmware download by using ***FWDN V8***.

4. Enter **.\fwdn.bat** command to start the download.
```
.\fwdn.bat
