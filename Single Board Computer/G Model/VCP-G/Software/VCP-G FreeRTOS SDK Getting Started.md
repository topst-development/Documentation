...
1. **Download the Toolchain:** Enter **wget** command to download the toolchain form the Linaro website:
    ...
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Download%20Toolchain.png?raw=true"></p>
...
2. **Extract the Toolchain:* After the download is complete, extract the contents of the ".tar.xz" file.
    ...
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Extract%20Toolchain.png?raw=true"></p>
...
3. **Move the Toolchain to /opt:** The /opt directory is a standard location for optional software on Linux. Move the extracted toolchain to this directory.
    ...
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Move%20Toolchain.png?raw=true"></p>
...
1. **Navigate to the Toolchain Directory**
    ...
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Navigate%20to%20Toolchain%20Directory.png?raw=true"></p>
...
2. **Check the Version of the Installed GCC Compiler**
    ...
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Check%20Version%20of%20Installed%20GCC%20Compiler.png?raw=true"></p>
...
2. **Navigate to the desired directory:** Choose a suitable location to save the source code. For example, if you want to save the repository in the home directory, use the following command.
    ...
    cd ~
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Navigate%20to%20Desired%20Directory.png?raw=true"></p>
...
3. **Clone the Repository:** Use the following command to clone the TOPST VCP-G source code from the provided git address.
    ...
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Clone%20Repository.png?raw=true"></p>
...
4. **Navigate to the Cloned Directory:** After the cloning process is complete, use the following command to navigate to the directory containing the source code.
    ...
    cd topst-vcp
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Navigate%20to%20Cloned%20Directory.png?raw=true"></p>
...
ls -al
```
<p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Source%20Code%20Structure.png?raw=true"></p>
...
2. **Run the make command:**
    ...
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Run%20make%20Command.png?raw=true"></p>
...
3. **Verify the Build Output:** After the build process is complete, the following output files should be listed in the terminal.
    ...
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Verify%20Build%20Output.png?raw=true"></p>
    <p align="center"><strong>Figure 5.2 Verify Build Output</strong></p>
    To check the list of output files, use the following command:
    ```
    ls output/ -al
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Build%20Output%20File.png?raw=true"></p>
...
4. **Verify USB Connection:** In WSL2, execute the following commands.
    ...
    sudo dmesg | grep tty
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Verify%20USB%20Connection.png?raw=true"></p>
...
1. **Set the Board to Download Mode:** Connect the power cable to the TOPST VCP-G board while pressing the FWDN switch.
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Set%20Board%20to%20Download%20Mode.png?raw=true"></p>
...
2. **Execute the Download Command:** Use ***FWDN*** to download the built software to the 4 MB flash on the VCP-G board.
    ...
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Execute%20Download%20Command.png?raw=true"></p>
...
3. **Reset the Board:** After the download process is complete, disconnect and reconnect the power cable.
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Reset%20the%20Board.png?raw=true"></p>
...
1. **Install Minicom**
    ...
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Install%20Minicom.png?raw=true"></p>
...
2. Open a Serial Connection: Use the following command to initiate a serial connection.
    ...
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Open%20Serial%20Connection.png?raw=true"></p>
...
<p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Figure%206.7%20Open%20Serial%20Connection.png?raw=true"></p>
...
2. **Log Out and Log Back In:** Log out of the current session and log back in to apply the changes. After this, try accessing the ttyUSB0 device again.
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Modify%20User%20Group%20Permissions.png?raw=true"></p>
...
1. **Start Minicom:** Use the following command.
    ...
    minicom -D /dev/ttyUSB0 -b 115200 -8
    ```
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Launch%20Minicom.png?raw=true"></p>
...
2. **Access the Setup Screen:** While in minicom, press **Ctrl+A** then press **o** to open the setup menu.
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Access%20Set%20up%20Screen.png?raw=true"></p>
...
4. **Modify Flow Control:** Inside the serial port setup, press **F** to set the hardware flow control to **No**.
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Modify%20Flow%20Control.png?raw=true"></p>
...
5. **Exit and Save:** Exit the setup and save the configuration. Minicom should now communicate properly with the TOPST VCP-G board.
    <p align="center"><img src="https://github.com/topst-development/Documentation/blob/main/Assets/TOPST%20VCP-G/Software/Save%20and%20Exit.png?raw=true"></p>
