...
>!(정정필요)! FWDN mode가 활성화가 안되어서 무한 uploading 상태일 수도 있고 다른 이유 때문일 수도 있나요? (may 때문에 다른 이유가 있을 수도 있는 것처럼 읽힘)
6.	If the onboard LED starts blinking, the board is set up correctly.
