...
This section describes the three sample/test applications provided in the TCC750x Linux NN SDK. Each application is designed to help users evaluate and utilize the AI capabilities of the TOPST AI-G board. The applications cover various scenarios such as NPU inference testing and real-time camera input.
<br/><br/><br/>
...
The Real-time Performance Toolkit (RTPT) is a GUI-based tool developed in Python that monitors output from the TOPST AI-G board in a PC environment. It allows you to observe inference results as well as system performance merics such as CPU, NPU, and memory usage.  
