...
<p align="center"><strong>Figure 2.2 Camera and Display connection on AI-G </strong></p><br/> 
...
These annotated frames are displayed in real time on the 5-inch DSI display, providing immediate visual feedback to the user.

In addition to visual output, the system logs key performance indicators such as CPU usage, NPU utilization, and memory status, which can be monitored via serial console or remote interface.
...
<p align="center"><strong>Figure 2.4 Camera and RTPM communication via AI-G </strong></p><br/>
