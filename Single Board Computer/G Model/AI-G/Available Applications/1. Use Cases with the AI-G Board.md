...
Currently, the AI-G board supports only the ArduCam (5MP) and Raspberry Pi v1 Camera (5MP) modules.
<br/><br/>
...
| Compatibility            | Raspberry Pi, AI-G (via MIPI CSI port)      |
...
<p align="center"><strong>Figure 2.1 Ardu cam </strong></p><br/>
...
<p align="center"><strong>Figure 2.2 Connecting the ArduCam to AI-G </strong></p><br/>
...
<p align="center"><strong>Figure 2.3 Raspberry pi v1 cam </strong></p><br/>

#### Step 1. Connect pi v1 cam to AI-G MIPI CSI
<p align="center"><img src="https://raw.githubusercontent.com/topst-development/Documentation/refs/heads/main/Assets/TOPST%20AI-G/Available%20Applications/Figure%202.%20Connecting%20Cam%20to%20AI-G.png" width="500"></p>
<p align="center"><strong>Figure 2.4 Connecting the Raspberry pi v1 cam to AI-G </strong></p><br/>
...
<p align="center"><strong>Figure 3.2 Connecting the Display to AI-G </strong></p><br/>
...
<p align="center"><strong>Figure 4.2 AI-G NVME M.2 SSD connection  </strong></p><br/>
...
<p align="center"><strong>Figure 5.1 Network Connection Via Router</strong></p><br/>
...
<p align="center"><strong>Figure 5.5 Nework Sharing with the Host PC</strong></p><br/>
...
In this example, the touch sensor is connected to the TOPST AI-G board, and its output is monitored through GPIO79.
...
- Touch Sensor
    ...
    - Connect the OUT pin (signal) to pin 8 (GPIO88) of the AI-G board.
...
<p align="center"><strong>Figure 6.3 AI-G GPIO Touch Sensor Circuit Schematic  </strong></p><br/>
...
#### Step 3. How to execute
To monitor the touch sensor input connected to GPIO79 on the AI-G board, simply run the following code:
...
#### Step 4. Execution Result
When executed, this script will detect touch input on GPIO88.
Upon contact with the touch surface, the sensor sends a HIGH signal, and the message "Touch detected (value: 1)" is printed to the console.

To stop the script, press Ctrl+C. The script will then unexport GPIO79 automatically.
...
Note: GPIO88 is used here as an example. You may choose a different GPIO pin, but be sure to consult the official 40-pin pinout diagram of the AI-G board to avoid conflicts.
<br/><br/><br/>
...
In this example, the sensor is connected to the TOPST AI-G board, and vibration input is detected via a digital GPIO 88.
...
- Vibration Detection Sensor
    ...
    - Connect DO(Digital Output) to pin 8 (GPIO88) of the AI-G board.
...
<p align="center"><strong>Figure 6.3 AI-G GPIO Vibration Detection Sensor Circuit Schematic  </strong></p><br/>
...
#### Step 3. How to execute
To monitor the vibration detection sensor input connected to GPIO88 on the AI-G board, simply run the following code:
...
#### Step 4. Execution Result
When executed, this script will detect vibration input on GPIO88.
When the sensor detects vibration or shock, it sends a HIGH signal, and the message "Vibration detected (value: 1)" is printed to the console.

To stop the script, press Ctrl+C. The script will then unexport GPIO88 automatically.
...
In this example, the SZH-SSBH-002 infrared sensor is connected to the TOPST AI-G board, and obstacle detection is monitored via digital GPIO 88.
...
- Touch Sensor
    ...
    - Connect the Out to pin 8 (GPIO88) of the AI-G board.
...
<p align="center"><strong>Figure 6.3 AI-G GPIO Infrared Sensor Circuit Schematic  </strong></p><br/>
...
#### Step 3. How to execute
To monitor the infrared sensor input connected to GPIO88 on the AI-G board, simply run the following code:
...
#### Step 4. Execution Result
When executed, this script will detect obstacle input on GPIO88.
When the sensor detects a nearby object, it sends a HIGH signal, and the message "Obstacle detected (value: 1)" is printed to the console.
...
Air Pollution Detection Sensor (e.g., MQ-series) detects the presence of combustible or toxic gases such as LPG, methane, CO, or smoke.
When gas concentration exceeds a certain threshold, the sensor outputs a HIGH signal through its digital output pin (DO).
In this example, the sensor is connected to the TOPST AI-G board and gas presence is detected via GPIO88.
...
- Air Pollution Detection Sensor
    ...
    - DO(Digital Output) pin of the Air Pollution Detection Sensor is connected to pin 8 (GPIO88) of the AI-G board.
...
<p align="center"><strong>Figure 6.3 AI-G GPIO Air Pollution Detection Sensor Circuit Schematic  </strong></p><br/>
...
#### Step 3. How to execute
To monitor the air pollution detection sensor input connected to GPIO88 on the AI-G board, simply run the following code:
...
#### Step 4. Execution Result
When executed, this script will detect gas input on GPIO88.
...
<p align="center"><strong>Figure 6.4 AI-G I2C LCD Display Circuit Schematic  </strong></p><br/>

##### Step 2.1 Pin Mapping
The following table shows pin mapping.

<div style="text-align: center;">
  <p><strong>Table 6.3 Pin Mapping of AI-G LCD Display</strong></p>
  <table style="margin: 0 auto; border-collapse: collapse;" border="1">
    <tr>
      <th colspan="3">Pin Name</th>
      <th>AI-G Board</th>
...
<p align="center"><strong>Figure 6.5 AI-G SPI Dot Matrix Circuit Schematic  </strong></p><br/>

##### Step 2.1 Pin Mapping
The following table shows pin mapping.

<div style="text-align: center;">
  <p><strong>Table 6.4 Pin Mapping of AI-G Dot Matrix</strong></p>
  <table style="margin: 0 auto; border-collapse: collapse;" border="1">
    <tr>
      <th colspan="3">Pin Name</th>
      <th>AI-G Board</th>
...
<p align="center"><strong>Figure 6.6 AI-G UART Circuit Schematic  </strong></p><br/>

##### Step 2.1 Pin Mapping
The following table shows pin mapping.

<div style="text-align: center;">
  <p><strong>Table 6.5 Pin Mapping of AI-G UART</strong></p>
  <table style="margin: 0 auto; border-collapse: collapse;" border="1">
    <tr>
