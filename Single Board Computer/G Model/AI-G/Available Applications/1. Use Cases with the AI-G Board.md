...
NOTE: Connect the display and power up the board, or if it is already powered up, reboot is required after connecting the display.
<br/><br/><br/><br/>
...
#### Step 3. How to execute
To monitor the touch sensor input connected to GPIO88 on the AI-G board, simply run the following code:
...
In this example, the sensor is connected to the TOPST AI-G board, and vibration input is detected via a digital GPIO 89.
...
- Vibration Detection Sensor
    ...
    - DO(Digital Output) pin of the Vibration Detection Sensor is connected to pin 10 (GPIO89) of the AI-G board.
...
#### Step 3. How to execute
To monitor the vibration detection sensor input connected to GPIO89 on the AI-G board, simply run the following code:
...
#### Step 4. Execution Result
When executed, this script will detect vibration input on GPIO89.
...
To stop the script, press Ctrl+C. The script will then unexport GPIO89 automatically.
...
Note: GPIO89 is used here as an example. You may choose a different GPIO pin, but be sure to consult the official 40-pin pinout diagram of the AI-G board to avoid conflicts.
<br/><br/><br/>
