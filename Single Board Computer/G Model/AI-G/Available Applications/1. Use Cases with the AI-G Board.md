...
**Note**: GPIO89 is used here as an example. You may use any availble GPIO pin on the AI-G based on the 40-pin header pinmap. Refer to the official 40-pin pinout diagram of the AI-G to avoid conflicts.
...
**Note**: GPIO88 is used here as an example. You may use any availble GPIO pin on the AI-G based on the 40-pin header pinmap. Refer to the official 40-pin pinout diagram of the AI-G to avoid conflicts.
