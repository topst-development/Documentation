# 1. Introduction 
This document provides examples of using the TOPST AI-G.   
...
<p align="center"><strong>Figure 2.2 Connect Display to TOPST AI-G </strong></p><br/>
...
### 3.1.1 ArduCam
ArduCam is a versatile camera module designed for embedded systems and AI applications. It supports various image sensors and interfaces, including MIPI CSI, making it suitable for integration with development boards like the TOPST AI-G.  
...
<p align="center"><strong>Figure 3.2 Connect ArduCam to TOPST AI-G </strong></p><br/>
...
Originally designed for the Raspberry Pi series, this module is also compatible with the TOPST AI-G board through the 15-pin MIPI CSI connector. It provides a reliable solution for entry-level camera applications such as image capture, video streaming, and AI-powered computer vision tasks on the TOPST AI-G platform.
...
<p align="center"><img src="https://raw.githubusercontent.com/topst-development/Documentation/refs/heads/main/Assets/TOPST%20AI-G/Available%20Applications/Figure%202.%20Connecting%20Cam%20to%20AI-G.png" width="500"></p>
<p align="center"><strong>Figure 3.4 Connect Raspberry Pi v1 Camera to TOPST AI-G </strong></p><br/>
...
This chapter covers how to connect the TOPST AI-G board to various storage devices. Supported storage options include external storage through PCIe.
<br/><br/><br/>
...
This method connects the TOPST AI-G board to a local network by using a standard router. The board can obtain an IP address automatically through DHCP or be configured with a static IP address.
<br/><br/>
...
The TOPST AI-G board features a 40-pin GPIO header, providing flexible I/O capabilities for various hardware projects.
...
To demonstrate digital output, an LED can be connected to one of the GPIO pins on the 40-pin header. In this example, the LED's cathode (short leg) is connected to the GND pin on the TOPST AI-G board, while the anode (long leg) is directly connected to GPIO72.
...
The 1602A LCD is a character display module commonly used in embedded systems. On the TOPST AI-G board, the LCD's SDA and SCL lines can be connected to GPIO pins configured for I2C. Once connected, the LCD can be controlled using the Linux I2C tools or custom software.
