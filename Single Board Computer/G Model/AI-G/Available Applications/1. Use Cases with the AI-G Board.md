...
<p align="center"><strong>Figure 2.3 Raspberry pi v1 cam </strong></p>

#### Step 1. Connect pi v1 cam to AI-G MIPI CSI
<p align="center"><img src="https://raw.githubusercontent.com/topst-development/Documentation/refs/heads/main/Assets/TOPST%20AI-G/Available%20Applications/Figure%202.%20Connecting%20Cam%20to%20AI-G.png" width="500"></p>
<p align="center"><strong>Figure 2.4 Connecting the Raspberry pi v1 cam to AI-G </strong></p> 
...
<p align="center"><strong>Figure 3.1 5 inch DSI Display </strong></p>
...
<p align="center"><strong>Figure 3.2 Connecting the Display to AI-G </strong></p> 
...
<p align="center"><strong>Figure 4.2 AI-G NVME M.2 SSD connection  </strong></p>
...
<p align="center"><strong>Figure 5.1 Network Connection Via Router</strong></p>
...
<p align="center"><strong>Figure 5.2 Select properties</strong></p>
...
<p align="center"><strong>Figure 5.3 Select sharing tab</strong></p>
...
<p align="center"><strong>Figure 5.4 Select Ethernet adapter</strong></p>
...
<p align="center"><strong>Figure 5.5 Nework Sharing with the Host PC</strong></p>
...
<p align="center"><strong>Figure 6.1 40 Pin GPIO Header Pinmap of AI-G  </strong></p>
...
<p align="center"><strong>Figure 6.2 AI-G GPIO LED Circuit Schematic  </strong></p>

##### Step 2.1 Pin Mapping
The following table shows pin mapping.

<p align="center"><strong>Table 6.1 Pin Mapping of AI-G LED</strong></p>
<table align="center">
    <tr>
...
<p align="center"><strong>Figure 6.3 AI-G GPIO Button Circuit Schematic  </strong></p>

##### Step 2.1 Pin Mapping
The following table shows pin mapping.

<p align="center"><strong>Table 6.2 Pin Mapping of AI-G Button</strong></p>
<table align="center">
    <tr>
        <th colspan="3">Pin Name</th>
        <th>AI-G Board</th>
...
<p align="center"><strong>Figure 6.4 AI-G I2C LCD Display Circuit Schematic  </strong></p>

##### Step 2.1 Pin Mapping
The following table shows pin mapping.

<p align="center"><strong>Table 6.3 Pin Mapping of AI-G LCD Display</strong></p>
<table align="center">
    <tr>
        <th colspan="3">Pin Name</th>
        <th>AI-G Board</th>
...
<p align="center"><strong>Figure 6.5 AI-G SPI Dot Matrix Circuit Schematic  </strong></p>

##### Step 2.1 Pin Mapping
The following table shows pin mapping.

<p align="center"><strong>Table 6.4 Pin Mapping of AI-G Dot Matrix</strong></p>
<table align="center">
    <tr>
        <th colspan="3">Pin Name</th>
        <th>AI-G Board</th>
...
<p align="center"><strong>Figure 6.6 AI-G UART Circuit Schematic  </strong></p>

##### Step 2.1 Pin Mapping
The following table shows pin mapping.

<p align="center"><strong>Table 6.5 Pin Mapping of AI-G UART</strong></p>
<table align="center">
    <tr>
