...
<p align="center"><strong>Figure 2.1 Connection between Host PC and TOPST AI-G Board</strong></p><br/>
...
image from the RTPM, and then sends the NPU Inference results on TOPST AI-G Board back to the RTPM.
...
It includes tool installation, workspace configuration, and how to run the RTPM interface for monitoring NPU performance and inference results on the TOPST AI-G board.
...
5.  Start Injection mode of tcnnapp on the TOPST AI-G board. (The order of execution does
...
3.  Start Projection mode of tcnnapp on the TOPST AI-G board.
