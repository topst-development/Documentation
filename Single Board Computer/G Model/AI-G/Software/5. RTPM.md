# 1. Introduction
The Real-Time Performance Monitor (RTPM) toolkit is a Python-based graphical application designed to monitor and visualize the performance metrics of the TOPST AI-G board in real time. By connecting a connection between the AI-G board and a Host PC, RTPM facilitates the transmission and analysis of key performance data, including CPU, NPU, memory utilization, and inference times.

RTPM operates in two distinct modes:

**Injection Mode**: In this mode, the Host PC sends the image data to the AI-G board for processing. The board performs inference using its NPU and returns the results to the PC for visualization.

**Projection Mode**: In this mode, the AI-G board captures images through its connected camera, processes them internally, and transmits the inference results to the RTPM on the host PC.
...
<p align="center"><strong>Figure 2.1 Connection between Host PC and TOPST AI Board</strong></p><br/>

- **RTPM Download** : <[RTPM](https://drive.google.com/file/d/1x3gaMhw53YloNul8m75R5fCPqzNl0RI9/view?usp=sharing)>
- The download is currently restricted; contact the community for access.
...
by using Python that monitors the output of the TOPST AI-G in a PC environment
...
This section provides step-by-step instructions for setting up the RTPM (Real-Time Performance Monitor) application on a Host PC.
It includes tool installation, workspace configuration, and how to run the RTPM interface for monitoring NPU performance and inference results on the TOPST AI board.
...
4.  Set the Workspace and add the "rtpm" directory.
...
<p align="center"><strong>Figure 2.9 Set Workspace and add "rtpm" directory</strong></p><br/>
...
7.  Run RTPM
	...
	<p align="center"><strong>Figure 2.12 Ctrl + F5</strong></p><br/>

<br/>

### 2.4.3 Using Injection Mode

1.  Select Folder (only image) mode in RTPM.
...
<p align="center"><strong>Figure 2.13 Change the Input Mode to Folder (only image)</strong></p><br/>
...
<p align="center"><strong>Figure 2.14 Select the image folder</strong><br/>

3.  Image folder selected in RTPM.
...
<p align="center"><strong>Figure 2.15 Image folder selected in RTPM</strong></p><br/>

4.  Start RTPM.

5.  Start Injection mode of tcnnapp on the TOPST AI board. (The order of execution does
...
<p align="center"><strong>Figure 2.18 Check Result File</strong></p><br/>
...
3.  Start Projection mode of tcnnapp on the TOPST AI board.
...
<p align="center"><strong>Figure 2.21 Check the information in real time through the camera</strong></p><br/>
