...
2. Install Python 3.10
   ...
   2. open the Extensions view by clicking the Extensions icon in the left sidebar, or by pressing 
   *Ctrl + Shift + X*.
   3. In the Extensions search bar, type Python.
   4. Find the Python extension provided by Microsoft, and click Install.
...
2.  Select the image folder you want to inference.
