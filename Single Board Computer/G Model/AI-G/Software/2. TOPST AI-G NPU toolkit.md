...
# 4. NPU Compatible Operators

This section introduces the operators supported by the NPU. The following list includes the key operations that are compatible with the platform.

## 4.1 AI-G NPU SUPPORTED LAYER TYPE
Supported layer type specification by TCC750x NPU.
<table border="1" cellspacing="0" cellpadding="5">
  ...
  <thead>
    <tr>
      ...
      <th colspan="2" style="text-align: center;">Specification</th>
    </tr>
  </thead>
  <tbody>
  <tr>
      <td colspan="1"style="text-align: center;">Convolution</td>
      <td>

- Kernel size: 1x1 to 7x7
- stride: 1 to 4
- padding: 0 to 3
- Dilation 1 to 4</td>
    <tr>
 <tr>
      <td colspan="1"style="text-align: center;">Depth-wise Convolution</td>
      <td>

- Kernel size: 1x1 to 5x5
- stride: 1 to 2
- padding: 0 to 2</td>
 <tr>
      <td colspan="1"style="text-align: center;">Activation Function</td>
      <td>
...
- Swish</td>
 <tr>
      <td colspan="1"style="text-align: center;">Max Pool 2D</td>
      <td>

- Kernel size: 2x2 to 13x13
- stride: 1 to 4
- padding: 0 to 6</td>
 <tr>
      <td colspan="1"style="text-align: center;">Average Pool 2D</td>
      <td>
...
- padding: 0 to 6</td>
 <tr>
      <td colspan="1"style="text-align: center;">Global Average Pool</td>
      <td colspan="1"style="text-align: center;"></td>
<tr>
  <td style="text-align: center; vertical-align: top;">Element-wise</td>
 ...
 <tr>
      <td colspan="1"style="text-align: center;">Upscale</td>
      <td>2x, Nearest Neighborhood</td>
 <tr>
      <td colspan="1"style="text-align: center;">Batch Normalization</td>
      <td colspan="1"style="text-align: center;"></td>
 <tr>
      <td colspan="1"style="text-align: center;">Concatenation</td>
<tbody>
</table>
...
## 4.2 ONNX OPERATORS
Note: Even if the operator is not supported, the operation of the last layer of the neural network can be processed through the Host 
CPU.
<table border="1" cellspacing="0" cellpadding="5">
  <colgroup>
    <col style="width: 10%">
  ...
  <thead>
    <tr>
      ...
      <th colspan="2" style="text-align: center;">Dedicated HW</th>
    </tr>
  </thead>
  <tbody>
  <tr>
      <td colspan="1"style="text-align: center;">Add</td>
      <td>
...
- Vector + Tensor
    ...
    <tr>
 <tr>
      <td colspan="1"style="text-align: center;">AveragePool</td>
      <td>
...
- padding: 0 to 6</td>
 <tr>
      <td colspan="1"style="text-align: center;">BatchNorm</td>
      <td colspan="1"style="text-align: center;">	O</td>
 <tr>
      <td colspan="1"style="text-align: center;">Concat</td>
      <td>Channel-wise concatenation only (Only 32-aligned channel size)</td>
 <tr>
      <td colspan="1"style="text-align: center;">Constant</td>
      <td colspan="1"style="text-align: center;">O</td>
 <tr>
      <td colspan="1"style="text-align: center;">ConstantOfShape</td>
      <td colspan="1"style="text-align: center;">O</td>
<tr>
  <td style="text-align: center; vertical-align: top;">Conv</td>
  <td style="padding: 8px;">
    &nbsp;&nbsp;• conv2d<br/>
    &nbsp;&nbsp;• kernel: 1x1 to 7x7<br/>
    &nbsp;&nbsp;• Tpadding: 0 to 3<br/>
    &nbsp;&nbsp;• stride: 1 to 4<br/>
    &nbsp;&nbsp;• dilation: 1 to 4<br/>
    &nbsp;&nbsp;• dw-conv<br/>
    &nbsp;&nbsp;• kernel: 1x1 to 5x5<br/>
    &nbsp;&nbsp;• padding: 0 to 2<br/>
    &nbsp;&nbsp;• stride: 1 to 2<br/>
    &nbsp;&nbsp;• dilation: 1
  </td>
 ...
 <tr>
      <td colspan="1"style="text-align: center;">ConvTransposed</td>
      <td>	
stride=2 only</td>
 <tr>
      <td colspan="1"style="text-align: center;">Div</td>
      <td>	
constant divisor only</td>
 <tr>
      <td colspan="1"style="text-align: center;">Flatten</td>
      <td colspan="1"style="text-align: center;">O</td>
 <tr>
      <td colspan="1"style="text-align: center;">Gemm</td>
      <td colspan="1"style="text-align: center;">O</td>
 <tr>
      <td colspan="1"style="text-align: center;">GlobalAveragePool
</td>
      <td colspan="1"style="text-align: center;">O</td>
 <tr>
 <td colspan="1"style="text-align: center;">LeakyRelu
</td>
      <td colspan="1"style="text-align: center;">O</td>
 <tr>
      <td colspan="1"style="text-align: center;">MatMul</td>
      <td>	One tensor should be constant.</td>
 <tr>
      <td colspan="1"style="text-align: center;">MaxPool</td>
      <td>	
...
- Padding: 0 to 6</td>
 <tr>
      <td colspan="1"style="text-align: center;">Mul</td>
      <td>	
...
- Vector + Tensor</td>
 <tr>
      <td colspan="1"style="text-align: center;">Pad</td>
      <td>	
- pad followed by conv layer only

- zero padding only

- pad size: 0 to 3</td>
 <tr>
      <td colspan="1"style="text-align: center;">DReduceMeaniv</td>
      <td>axes = [h, w] only</td>
 <tr>
      <td colspan="1"style="text-align: center;">ReduceSum</td>
      <td>axes = [h, w] only</td>
 <tr>
      <td colspan="1"style="text-align: center;">Relu</td>
      <td colspan="1"style="text-align: center;">O</td>
 <tr>
      <td colspan="1"style="text-align: center;">Resize</td>
      <td>2x nearest-neighborhood upsample only</td>
 <tr>
      <td colspan="1"style="text-align: center;">Shape</td>
      <td colspan="1"style="text-align: center;">O</td>
 <tr>
      <td colspan="1"style="text-align: center;">Sigmoid</td>
      <td colspan="1"style="text-align: center;">O</td>
 <tr>
      <td colspan="1"style="text-align: center;">Slice</td>
      <td>	

- Channel-wise: 32-aligned channel size

- Row-wise: supported</td>
 <tr>
      <td colspan="1"style="text-align: center;">Sub</td>
      <td colspan="1"style="text-align: center;">O</td>
 <tr>
      <td colspan="1"style="text-align: center;">Tanh</td>
      <td colspan="1"style="text-align: center;">O</td>
 <tr>
      <td colspan="1"style="text-align: center;">Unsqueeze</td>
      <td colspan="1"style="text-align: center;">O</td>
<tr>
      <td colspan="1"style="text-align: center;">UnsqUpsampleueeze</td>
      <td >2x nearest-neighborhood upsample only</td>
<tbody>
</table>

## 4.3 DARKNET OPERATORS

## 4.4 TSENSOR FLOW LITE OPERATORS