...
<p align="center"><strong>Figure 1.1 TOPST AI-G SW Tool Kit Overview</strong></p><br/>
...
<p align="center"><strong>Figure 2.1 TOPST AI-G NPU Tool Kit Directory</strong></p><br/>
...
| Depth-wise Convolutio   | Kernel size: 1x1 to 5x5<br/>Stride: 1 to 2<br/>Padding: 0 to 2<br/>Dilation 1 to 4 |
...
## 4.2 PyTorch OPERATORS (ONNX)
Even if the operator is not supported, the operation of the last layer of the neural network can be processed through the Host CPU.
...
| Conv Transposed         |  Kernel: 2x2 to 3x3<br/Padding: 0 to 1<br/>Stride: 2<br/>Output_padding: 0 to 1  |                                              |  
...
| GlobalAveragePool       | O                                                           |
| Add                     | **Dedicated HW**<br/>Scalar + Tensor <br/> Tensor + Tensor <br/>
**Vector Processor** <br/>Vector + Tensor |
| Sub                     | O (Converted to Addopeator)                                 |
...
| MUL                     | **Dedicated HW**<br/>Scalar * Tensor<br/>Tensor * Tensor<br/>**Vector Processor**<br/>Tensor * Tensor     | 
| DIV                     | O<br/>Constant divisor only                                 |
