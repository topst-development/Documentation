# 1. Introduction
---
Neural Processing Unit (NPU) is an HW neural network accelerator and the NPU in TCC750x is optimized for the inference of neural networks for vision applications, such as object detection, image classification, and face detection.  
