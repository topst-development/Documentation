...
The following examples are the device trees for using NPU device driver in AI-G board.
...
The IOCTL commands provided to use the AI-G board’s NPU are as follows.
