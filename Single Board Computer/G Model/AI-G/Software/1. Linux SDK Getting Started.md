...
The "output_nd.fwdn.zip" including the output.fai build image and ***FWDN*** tool is created in the following path: 
...
PART 4====================
name : system
size : 819200 sector(419430400 byte)
...
PART 8====================
name : home
size : 1638400 sector(838860800 byte)
location : build/ai-g-topst/tmp/deploy/home-directory.ext4
PART 9====================
name : data
size : 2048 sector(1048576 byte)
location : build/ai-g-topst/tmp/deploy/user-data.ext4
uuid : 92b8a906-9894-4d16-81f1-2f28dea91547 , part-name : bl3_ca53_a, first_lba : 34, last_lba : 4129
uuid : 430b25aa-8409-416e-b2e7-bc2d1f0b26ca , part-name : bl3_ca53_b, first_lba : 4130, last_lba : 8225
uuid : fd90309c-b54b-4d80-a355-a2b1bf30ea94 , part-name : boot, first_lba : 8226, last_lba : 90145
uuid : aa10704e-d1a6-4d6f-a6ac-a322f6900190 , part-name : system, first_lba : 90146, last_lba : 909345
uuid : 2f4aaf06-b0d5-4739-ab5e-803e8f14a6f8 , part-name : dtb, first_lba : 909346, last_lba : 909745
uuid : 05b1e532-a695-4d53-82b8-b2e4296041b1 , part-name : env, first_lba : 909746, last_lba : 911793
uuid : 6a8c507d-8e80-4dcc-978e-0fe14cc9a6aa , part-name : misc, first_lba : 911794, last_lba : 913841
uuid : b0a8c8f7-4024-49b4-b68a-6a3047bc9f19 , part-name : home, first_lba : 913842, last_lba : 2552241
uuid : 89f0bea1-fcdd-4ea3-b6e3-43942145d882 , part-name : data, first_lba : 2552242, last_lba : 2554289
crc32 of header : 947bda9e
crc32 of partition array : 9fbe1329
...
idx : 2  boot
BunchHeader.ullTargetAddress : 4211712, BunchHeader.ullLength = 16582656
idx : 3  system
BunchHeader.ullTargetAddress : 46154752, BunchHeader.ullLength = 386924544
idx : 4  dtb
BunchHeader.ullTargetAddress : 465585152, BunchHeader.ullLength = 55296
idx : 7  home
BunchHeader.ullTargetAddress : 467887104, BunchHeader.ullLength = 838860800
idx : 8  data
BunchHeader.ullTargetAddress : 1306747904, BunchHeader.ullLength = 1048576
crc32 of header : 947bda9e
crc32 of partition array : e50fc435
...
--parttype : gpt
--area_name : "SD Data"
--outfile : /home/eadweard/test/.stitch_VogxZMc/output_nd.fai
--gptfile : /home/eadweard/test/.stitch_VogxZMc/output_nd.gpt
--fplist : /home/eadweard/test/.stitch_VogxZMc/partition.list
--sector_size : 512
--sparse_fill : 0
...
[+] Packaging FWDN binaries
 ...
 (deflated 94%)
  ...
  adding: output_nd.gpt (deflated 98%)
  adding: output_nd.gpt.back (deflated 97%)
  adding: output_nd.gpt.prim (deflated 97%)
...
```
$ ls
output_nd.fwdn.zip  build               easy-setup.sh       mktcimg           poky                stitch-fai-ai.sh    stitch-fai-d3.sh    tools
```
