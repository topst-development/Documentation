...
--parttype : gpt
--area_name : "SD Data"
--outfile : /home/topst/topst-sdk/.stitch_AcJHHLv/output_nd.fai
--gptfile : /home/topst/topst-sdk/.stitch_AcJHHLv/output_nd.gpt
...
[+] Packaging FWDN binaries
  adding: output_nd.fai (deflated 74%)
  ...
  adding: output_nd.gpt.back (deflated 98%)
  adding: output_nd.gpt.prim (deflated 98%)
...
Before executing ***FWDN***, WMIC must be installed to know the port connected to the FWDN port of the AI-G board.
>!(정정필요)! 어떤 포트가 FWDN 포트에 연결되어 있는지를 알기 위해라는 의미인가요? 
...
4. View Features: Click the **View Features**  next to **Add Optional Features**.
...
6. Install: Select the WMIC item and click **"Next"** to complete the installation.
...
$ cd C:\images 
```
8. Enter the **.\fwdn_nd.bat** command to start the firmware download. “fwdn_nd.bat” is an executable file that automatically downloads firmware by using ***FWDN V8***. 
