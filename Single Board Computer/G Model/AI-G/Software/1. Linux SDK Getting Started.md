...
3. Execute Windows PowerShell and go to “C:\images”.  
```
$ cd C:\images 
```
4. Enter **.\fwdn_nd.bat** command to start the firmware download. The “fwdn_nd.bat” is an executable file that automatically downloads firmware by using ***FWDN V8***. 
