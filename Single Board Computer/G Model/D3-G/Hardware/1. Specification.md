...
Table 1.2 describes the connectors and components on the TOPST D3-G (top view).  
...
The TOPST D3-G reduces the CPU clock speed and voltage to reduce thermal output when the TOPST D3-G is in an idle state or has a light workload through Dynamic Voltage and Frequency Scaling (DVFS) solutions. The TOPST D3-G operates perfectly without any extra cooling devices. If you want to operate the TOPST D3-G at full performance for a long time, further cooling may be needed.
...
## 2.1 LPDDR4X
The LPDDR4X memory is located on the TOPST D3-G board and information on the LPDDR4X memory is as follows:
- 32-bit x 2 channel
- Density : 4 GB
...
<p align="center"><strong>Figure 2.1 LPDDR4X on TOPST D3-G </strong></p>

<br/><br/><br/>

## 2.2 eMMC
The eMMC memory is located on the TOPST D3-G board and information on the eMMC memory is as follows: 
- eMMC 5.1 
...
<p align="center"><strong>Figure 2.2 eMMC on TOPST D3-G </strong></p>

<br/><br/><br/>

## 2.3 Serial NOR Flash Memory (Optional) 

SNOR (Quad SPI type) is located on the TOPST D3-G board and information on the SNOR is as follows: 
- Quad I/O 
- Density: 256 Mb 
...
<p align="center"><strong>Figure 2.3 SNOR on TOPST D3-G</strong></p>
...
Figure 2.4 shows the power connector and DC jack component on TOPST D3-G.
...
<p align="center"><strong>Figure 2.4 Power Connector on TOPST D3-G </strong></p>
...
Figure 2.5 shows the JTAG connector component on TOPST D3-G.
...
<p align="center"><strong>Figure 2.5 JTAG Connector on TOPST D3-G </strong></p>

<br/><br/><br/>

## 2.6 PCIe Connector 
Figure 2.6 shows the PCIe connector that enables the use of PCIe interface devices on the TOPST D3-G board. The TOPST D3-G board supports PCIe Gen3 x 1-lane. For information on the pins, refer to TOPST AI-G Hardware-User Guide.
...
<p align="center"><strong>Figure 2.6 PCI Express Standard Connector on TOPST D3-G </strong></p>
...
<p align="center"><strong>Figure 2.7 MIPI CSI Connector on TOPST D3-G </strong></p>

<br/><br/><br/>


## 2.8 microSD Card Socket 
Figure 2.8 shows the microSD socket. The TOPST D3-G board supports SD3.0. 
...
<p align="center"><strong>Figure 2.8 microSD Card Socket on TOPST D3-G </strong></p>

<br/><br/><br/>

## 2.9 DP Connector (DP Port)
Figure 2.9 shows the DP connector on the TOPST D3-G board.For information on the pins, refer to TOPST AI-G Hardware-User Guide.
...
<p align="center"><strong>Figure 2.9 DP Connector on TOPST D3-G </strong></p>

<br/><br/><br/>

## 2.10 Debug UART Pin Header Male (J8S1) 
Figure 2.10 shows the debug UART header pin. It consists of 3 UART channels for debugging of each CPU core. Pin 1 (UART 5V) is a dummy pin and does not provide an output. For information on the pins, refer to TOPST AI-G Hardware-User Guide.
...
<p align="center"><strong>Figure 2.10 Debug UART Pin Header on TOPST D3-G </strong></p>
...
<p align="center"><strong>Figure 2.11 Ethernet Connector on TOPST D3-G </strong></p>
...
<p align="center"><strong>Figure 2.12 USB Connectors on TOPST D3-G </strong></p>
...
<p align="center"><strong>Figure 2.13 CAN Pin Header on TOPST D3-G </strong></p>

<br/><br/><br/>

## 2.14 General Purpose I/O Pin Header Male (JH1) 

Figure 2.14 shows the GPIO pin header on the TOPST D3-G board. The GPIO pin header can be used to connect the HAT, which is a Raspberry Pi accessory. For information on the pins, refer to TOPST AI-G Hardware-User Guide.
