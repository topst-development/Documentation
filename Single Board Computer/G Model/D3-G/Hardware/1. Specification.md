...
## 2.1 LPDDR4X
---
The LPDDR4X memory is located on the D3-G board and information on the LPDDR4X memory is as follows:
- 32-bit x 2 channel
- Density : 4 GB
...
## 2.2 eMMC
---
The eMMC memory is located on the D3-G board and information on the eMMC memory is as follows: 
- eMMC 5.1 
...
SNOR (Quad SPI type) is located on the D3-G board and information on the SNOR is as follows: 
- Quad I/O 
- Density: 256 Mb 
...
## 2.6 PCIe Connector 
---
Figure 2.6 shows the PCIe connector that enables the use of PCIe interface devices on the D3-G board. The D3-G board supports PCIe Gen3 x 1-lane. For information on the pins, refer to D3-G Hardware-User Guide.
...
---
Figure 2.7 shows the MIPI CSI connectors on the D3-G board. The D3-G board supports 2 channels of MIPI CSI, each configured with a 2-lane interface. A 4-lane interface is optional and requires a 20-pin connector.
For information on the pins, refer to D3-G Hardware-User Guide.
...
---
Figure 2.8 shows the microSD socket. The D3-G board supports SD3.0. 
...
---
Figure 2.9 shows the DP connector on the D3-G board.For information on the pins, refer to D3-G Hardware-User Guide.
...
---
Figure 2.10 shows the debug UART header pin. It consists of 3 UART channels for debugging of each CPU core. Pin 1 (UART 5V) is a dummy pin and does not provide an output. For information on the pins, refer to D3-G Hardware-User Guide.
...
---
Figure 2.11 shows the Ethernet connector on the D3-G board. The D3-G board have one Ethernet MAC controller. JC2 is an RJ45 connector that supports 10 Mbps, 100 Mbps, and 1000 Mbps Ethernet connections. 
...
## 2.12 USB Connectors 
---
D3-G board supports three types of USB: 
...
Figure 2.12 shows the USB connectors on the D3-G board. 
...
---
Figure 2.13 shows the CAN pin header on the D3-G board. The D3-G board supports 3-channel CAN. 
For information on the pins, refer to D3-G Hardware-User Guide.
...
---
Figure 2.14 shows the GPIO pin header on the D3-G board. The GPIO pin header can be used to connect the HAT, which is a Raspberry Pi accessory. For information on the pins, refer to D3-G Hardware-User Guide.
