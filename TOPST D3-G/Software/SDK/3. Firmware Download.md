...
The TOPST D3-G has one Boot Mode button and supports two types of boot modes: 
...
3. To enter USB Boot mode, as following 
   
4.  connect the power cable to the TOPST D3-G while pressing the FWDN switch. 

5. Connect the USB Type-C cable to the USB Type-C FWDN Port on the TOPST D3-G and the Host PC. 
...
### 1.2.1 How to install VTC Driver (Windows/Ubuntu)
