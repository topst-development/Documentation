...
1.  The NPU Device Driver controls the initialization of NPU HW, the
    delivery of compiled neural networks to NPU HW, the execution of NPU
...
## NPU Linux Device Driver Source Code
...
### IOCTL Interface for Network file descriptor
...
### IOCTL Interface for Buffer file descriptor
