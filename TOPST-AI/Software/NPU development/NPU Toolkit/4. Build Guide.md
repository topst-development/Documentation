...
<tr class="even">
<td>--output ./output_networks/yolov4.bin</td>
...
--dataset Custom
--dataset-root my_dataset_path
--output./output_networks/lite-model_ssd_mobilenet_v1_100_320_fp32_nms_1.bin
--enable-track
--mean 0.5 0.5 0.5
--std 0.5 0.5 0.5
--num-class 90
...
<tr class="odd">
<td>--output
./output_networks/lite-model_ssd_mobilenet_v1_100_320_fp32_nms_1.bin</td>
<td>Converter output file name</td>
</tr>
<tr class="even">
<td>--enable-track</td>
...
--dataset Custom
--dataset-root my_dataset_path
--output ./output_networks/mb2-ssd-lite.bin
--enable-track
...
<tr class="odd">
<td>--output ./output_networks/mb2-ssd-lite.bin</td>
<td>Converter output file name</td>
</tr>
<tr class="even">
<td>--enable-track</td>
...
```
$ python ./NPUSDK/quantizer.py 
./output_networks/yolov4.bin 
...
```
$ python ./NPUSDK/quantizer.py
./output_networks/lite-model_ssd_mobilenet_v1_100_320_fp32_nms_1.bin
...
```
$ python ./NPUSDK/quantizer.py
./output_networks/mb2-ssd-lite.bin
...
```
$ python ./NPUSDK/compiler.py 
./output_networks/yolov4_quantized.bin 
--th-iou 0.5 
--th-conf 0.5
```
...
```
$ python ./NPUSDK/compiler.py
./output_networks/lite-model_ssd_mobilenet_v1_100_320_fp32_nms_1_quantized.bin
--th-iou 0.5
--th-conf 0.5
```
...
```
$ python ./NPUSDK/compiler.py
./output_networks/mb2-ssd-lite_quantized.bin
--th-iou 0.5
--th-conf 0.5
```
