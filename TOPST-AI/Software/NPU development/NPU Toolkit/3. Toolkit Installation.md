...
$ cd TELECHIPS_NPU_V20_SW_Toolkit_v0.9.7
...
$ pip install torch==1.12.0+cpu torchvision==0.13.0+cpu torchaudio==0.12.0 --extra-index-url 
...
$ pip install ./telechips_viewer/netron-3.5.4-py2.py3-none-any.whl
$ deactivate
...
```
$ cd telechips_sw_toolkit_usage_example_telechips_v1.0

$ ln -s ../TELECHIPS_NPU_V20_SW_Toolkit_v0.9.7/venv
$ ln -s ../TELECHIPS_NPU_V20_SW_Toolkit_v0.9.7/NPUSDK
$ ln -s ../TELECHIPS_NPU_V20_SW_Toolkit_v0.9.7/tools_sdk
$ source ./venv/bin/activate
...
- Sample Networks Path:
  telechips_sw_toolkit_usage_example_telechips_v1.0/input_networks
