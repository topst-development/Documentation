...
TOPST D3(오픈 플랫폼 보드)는 다른 오픈 플랫폼 보드 및 TOPST 보드 시리즈와 하위 호환되는 40핀 헤더를 통해 28개의 GPIO를 제공합니다.  

<br/><br/>

## 1.2 GPIO 40핀 헤더
그림 1.1은 2.54 mm 피치 40핀 IDC 케이블을 나타냅니다.  
...
<p align="center"><strong>그림 1.1 2.54-mm 피치 40핀 IDC 케이블</strong></p>

그림 1.2는 GPIO 헤더의 1번 핀 위치와 IDC 케이블을 GPIO 헤더에 연결하는 방법을 나타냅니다.  
...
<p align="center"><strong>그림 1.2 40핀 GPIO 헤더 연결</strong></p>

<br/><br/>

## 1.3 GPIO 핀 할당  

그림 1.3은 GPIO 커넥터의 핀아웃을 나타냅니다.  
모든 GPIO는 입력 및 출력으로 사용할 수 있으며, 일부 GPIO 핀은 I2C, I2S, SPI 및 PWM 기능으로 전환할 수 있습니다.  
...
<p align="center"><strong>그림 1.4 GPIO 핀맵</strong></p>


표 1.1은 기본 핀 기능과 사용 가능한 대체 GPIO 기능을 상세히 설명합니다.  

**표 1.1 대체 GPIO 기능:**
| GPIO     | 헤더 핀 번호   | ALT0    | ALT1          | ALT2         | ALT3       | ALT4        | ALT5        | ALT6        |
|:--------:|:--------------:|:-------:|:-------------:|:------------:|:----------:|:-----------:|:-----------:|:-----------:|
