...
J20D1 為標準 40 針 GPIO 排針。  

圖 6.1 顯示外部 CPU 介面接頭（J20D1）的位置。
...
<p align="center"><strong>圖 6.1 標準 40 針 GPIO 排針</strong></p>

圖 6.2 顯示標準 40 針 GPIO 排針的電路圖。
...
<p align="center"><strong>圖 6.2 標準 40 針 GPIO 排針電路圖</strong></p>

表 6.1 顯示 J20D1 的腳位說明。  
...
| 1           |         -         | SYS_3P3     |       -        | 電源 3.3V      |
| 2           |         -         | B_5P0       |       -        | 電源 5.0V |
| 3           | GPIO_B01          | I2C0_SDA    |      ◀▶      | I2C 資料       |
| 4           |         -         | B_5P0       |       -        | 電源 5.0V       |
| 5           | GPIO_B00          | I2C0_SCL    |  ▶            | I2C 時脈     |
| 6           |         -         | DGND        |       -        | 接地        |
| 7           | GPIO_B04          | GPIO_B04    |  ◀            | GPIO 訊號  |
| 8           | GPIO_B25          | UT2_Tx      |  ▶            | UART 傳送      |
| 9           |         -         | DGND        |       -        | 接地      |
| 10          | GPIO_B26          | UT2_Rx      |  ▶            | UART 接收        |
| 11          | GPIO_B06          | GPIO_B06    |  ◀            | GPIO 訊號     |
| 12          | GPIO_A16          | GPIO_A16    |  ◀            | GPIO 訊號      |
| 13          | GPIO_B23          | GPIO_B23    |  ◀            | GPIO 訊號       |
| 14          |         -         | DGND        |       -        | 接地     |
| 15          | GPIO_K11          | GPIO_K11    |  ◀            | GPIO 訊號        |
| 16          | GPIO_AC04         | GPIO_AC04   |  ◀            | GPIO 訊號       |
| 17          |         -         | SYS_3P3     |       -        | 電源 3.3V    |
| 18          | GPIO_AC05         | GPIO_AC05   |  ◀            | GPIO 訊號        |
| 19          | GPIO_A24          | SPI3_SDO    |  ▶            | SPI 資料輸出         |
| 20          |         -         | DGND        |       -        | 接地         |
| 21          | GPIO_A25          | SPI3_SDI    |  ◀            | SPI 資料輸入          |
| 22          | GPIO_K09          | GPIO_K09    |  ◀            | GPIO 訊號          | 
| 23          | GPIO_A27          | SPI3_CLK    |  ▶            | SPI 時脈           |
| 24          | GPIO_A26          | SPI3_CS     |  ▶            | SPI 晶片選擇               |
| 25          |         -         | DGND        |       -        | 接地              |
| 26          | GPIO_C13          | SPI1_CS     |  ▶            | SPI 晶片選擇           |
| 27          | GPIO_B03          | I2C1_SDA    |  ◀▶          | I2C 資料            |
| 28          | GPIO_B02          | I2C1_SCL    |  ▶            | I2C 時脈          |
| 29          | GPIO_A29          | GPIO_A29    |  ◀            | GPIO 訊號          |
| 30          |         -         | DGND        |       -        | 接地          |
| 31          | GPIO_B19          | GPIO_B19    |  ◀            | GPIO 訊號          |
| 32          | GPIO_B11          | GPIO_B11    |  ◀            | GPIO 訊號          |
| 33          | GPIO_C11          | GPIO_C11    |  ◀            | GPIO 訊號          |
| 34          |         -         | DGND        |       -        | 接地          |
| 35          | GPIO_C15          | SPI1_DI     |  ◀            | SPI 資料輸入         |
| 36          | GPIO_B18          | GPIO_B18    |  ◀            | GPIO 訊號          |
| 37          | GPIO_A18          | GPIO_A18    |  ◀            | GPIO 訊號          |
| 38          | GPIO_C14          | SPI1_DO     |  ▶            | SPI 資料輸出          |
| 39          |         -         | DGND        |       -        | 接地           |
| 40          | GPIO_C12          | SPI1_CLK    |  ▶            | SPI 時脈          |

<br/>

表 6.2 顯示 J20D1 的腳位說明。 
