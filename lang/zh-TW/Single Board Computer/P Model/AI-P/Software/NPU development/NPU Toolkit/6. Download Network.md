...
<p align="center"><strong>圖 6.1 scp 指令</strong></p>

3.  請在 TOPST AI 主控台中依下列方式確認。
...
<p align="center"><strong>圖 6.2 確認下載結果</strong></p>

4.  在 TOPST AI 主控台中輸入下列指令，即可執行範例
    應用程式。
...
<p align="center"><strong>圖 6.3 範例應用程式執行畫面</strong></p>
