...
TOPST AI NPU Toolkit 已在搭載 Ubuntu 20.04 與 Python 3.8 的 64 位元
PC 上完成測試。不需要 GPU。
...
在安裝 python 套件之前，請先確認已安裝 python3.8 與相關
函式庫。TOPST AI NPU Toolkit 所需的 Python 套件，列在 Toolkit
套件目錄下的 requirements.txt
檔案中。
...
<p align="center"><strong>圖 3.1 範例網路</strong></p>
