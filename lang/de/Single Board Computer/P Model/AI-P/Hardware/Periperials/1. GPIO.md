...
Das TOPST AI (Open-Platform-Board) stellt 28 GPIOs über eine 40-Pin-Stiftleiste
bereit, die abwärtskompatibel zu anderen Open-Platform-Boards und zur
TOPST-Board-Serie ist.
...
Abbildung 1.2 zeigt den Pin Nummer 1 der GPIO-Stiftleiste und wie Sie
ein IDC-Kabel an die GPIO-Stiftleiste anschließen.
...
<p align="center"><strong>Abbildung 1.2 Pin Nummer 1 der GPIO-Stiftleiste</strong></p>
...
Alle GPIOs stehen als Ein- und Ausgänge zur Verfügung, und einige GPIO-Pins können
auf die Funktionen I2C, SPI und PWM umgeschaltet werden.
...
## 1.4 Alternative GPIO-Funktionen

Tabelle 1.1 beschreibt die Standard-Pinfunktionen und die verfügbaren
alternativen GPIO-Funktionen.
...
<td><p><strong>Stiftleiste</strong></p>
<p><strong>Pin-Nr.</strong></p></td>
