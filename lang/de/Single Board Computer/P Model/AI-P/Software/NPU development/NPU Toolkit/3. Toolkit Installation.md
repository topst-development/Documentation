...
Das TOPST AI NPU Toolkit wurde auf einem 64-Bit-PC mit Ubuntu 20.04 und
...
Stellen Sie vor der Installation der Python-Pakete sicher, dass python3.8 und die
zugehörigen Bibliotheken installiert wurden. Die vom TOPST AI NPU Toolkit
benötigten Python-Pakete sind in den Dateien requirements.txt im Verzeichnis
des Toolkit-Pakets aufgeführt.
...
## 3.2 Arbeitsverzeichnis konfigurieren
...
<p align="center"><strong>Abbildung 3.1 Beispielnetze</strong></p>
  ...
  **Tabelle 3.2 Beschreibung der Beispielnetze:**
