...
## 1.1 GPIO-Schnittstelle  


Das TOPST D3 (Open-Platform-Board) stellt 28 GPIOs über eine 40-Pin-Stiftleiste bereit, die abwärtskompatibel zu anderen Open-Platform-Boards und zur TOPST-Board-Serie ist.  

<br/><br/>

## 1.2 GPIO-40-Pin-Stiftleiste
Abbildung 1.1 zeigt das 40-polige IDC-Kabel mit 2.54 mm Raster.  
...
<p align="center"><strong>Abbildung 1.1 40-poliges IDC-Kabel mit 2.54-mm-Raster</strong></p>

Abbildung 1.2 zeigt den Pin Nummer 1 der GPIO-Stiftleiste und wie Sie ein IDC-Kabel an die GPIO-Stiftleiste anschließen.  
...
<p align="center"><strong>Abbildung 1.2 40Pin-GPIO-Stiftleiste anschließen</strong></p>

<br/><br/>

## 1.3 GPIO-Pinbelegung  

Abbildung 1.3 zeigt die Pinbelegung des GPIO-Anschlusses.  
Alle GPIOs stehen als Ein- und Ausgänge zur Verfügung, und einige GPIO-Pins können auf die Funktionen I2C, I2S, SPI und PWM umgeschaltet werden.  
...
<p align="center"><strong>Abbildung 1.3 Pinbelegung des GPIO-Anschlusses</strong></p>
...
<p align="center"><strong>Abbildung 1.4 GPIO-Pinbelegung</strong></p>


Tabelle 1.1 beschreibt die Standard-Pinfunktionen und die verfügbaren alternativen GPIO-Funktionen.  

**Tabelle 1.1 Alternative GPIO-Funktionen:**
| GPIO     | Header-Pin-Nr. | ALT0    | ALT1          | ALT2         | ALT3       | ALT4        | ALT5        | ALT6        |
|:--------:|:--------------:|:-------:|:-------------:|:------------:|:----------:|:-----------:|:-----------:|:-----------:|
