# 5. Beleuchtungsstärkesensor (BH 1750, SZH-SSBH-011)
### 5.1 BH 1750
* Stromversorgung für **3~5V**
* Datenbereich : 0~65535

Der folgende Code ist ein Beispielcode, der über die i2c-Kommunikation den Datenwert des Beleuchtungsstärkesensors ausliest und ihn als Verhältnis von 0 bis 100 zurückgibt.
```
import smbus
import time
import os
...
```
### 5.2 SZH-SSBH-011
* Stromversorgung für **3.3V, 5V**

Der folgende Code ist ein Beispielcode, der bei einem Datenwert von 0 aufgrund geringer Beleuchtungsstärke am Datenpin des Sensors ausschaltet und bei einem Datenwert von 1 aufgrund hoher Beleuchtungsstärke einschaltet.
Dieser Sensor hat einen Datenwert von 1, wenn es dunkel ist, und 0, wenn es hell ist.
```
import os
import time
