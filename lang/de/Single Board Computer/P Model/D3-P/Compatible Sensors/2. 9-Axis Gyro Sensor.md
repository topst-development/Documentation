# 2. 9-Achsen-Gyrosensor (MPU9250/GY9250)  
* Stromversorgung für **3V-5V**
* Beschleunigungsbereich : ±2G, ±4G, ±8G, ±16G
* Gyrosensor-Bereich : Einstellbar in ±250 , ±500, ±1000, ±2000 °/sec
* Maximaler Messbereich des Geomagnetsensors : ±4800uT

Der folgende Code ist ein Beispielcode für Beschleunigungs-, Gyro- und Geomagnetdatenwerte.
```
import smbus2
import time
