# 7. Infrarotsensor(SZH-SSBH-002)
* Stromversorgung für **3.3V~5V**

Der folgende Code ist ein Beispielcode, der Hindernisse erkennt, indem er reflektiertes Licht erfasst, sobald sich ein Objekt innerhalb eines bestimmten Abstands befindet.
```
import os
import time
