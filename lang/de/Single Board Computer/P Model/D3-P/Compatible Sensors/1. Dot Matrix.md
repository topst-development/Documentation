# 1. 8x8-Punktmatrix (MAX7219)
* Stromversorgung für **4.7V-5.3V DC**

Im Folgenden finden Sie einen Beispielcode, der 0-9, A-Z und Ausdrücke bei der Eingabe unverändert ausgibt.
```
#!/usr/bin/env python3
