# 4. Berührungssensor(TTP223B)  
* Stromversorgung mit **2~5.5V DC**
* Kapazitiver Typ

Der folgende Code ist ein Beispiel, bei dem die LED aufleuchtet, wenn Sie den Berührungserkennungsbereich des Berührungssensors berühren.
```
import time
import os
