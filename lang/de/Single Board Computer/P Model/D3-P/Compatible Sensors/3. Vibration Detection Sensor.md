# 3. Vibrationserkennungssensor (SW18010-P)
* Stromversorgung mit **DC 3.3V ~ 5V**

Nachfolgend finden Sie einen Beispielcode, der eine LED einschaltet, wenn eine Vibration erkannt wird.  
```
import time
import os
