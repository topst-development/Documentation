...
J14D1 是用于连接外部 CPU 开发板的连接器。  
但是，不提供用于连接的单独线缆。  

图 8.1 显示了外部 CPU 接口连接器 (J14D1) 的位置。
...
<p align="center"><strong>图 8.1 外部 CPU 接口连接器 (J14D1)</strong></p>


图 8.2 显示了外部 CPU 接口连接器 (J14D1) 的原理图。
...
<p align="center"><strong>图 8.2 外部 CPU 接口连接器原理图 (J14D1)</strong></p>

表 8.1 显示了 J14D1 的引脚说明。  

**表 8.1 J14D1 引脚说明：**  

|  引脚编号   | TCC7045 端口名称  | 信号名称    | 方向(MCU◀▶J14D1)| 说明                                        |
|:-----------:|:-----------------:|:-----------:|:--------------:|----------------------------------------------|
| 1           |         -         | B_UP        |  -             | 电源 12V                                     |
| 2           |         -         | B_UP        |  -             | 电源 12V                                     |
| 3           |         -         | DGND        |  -             | 接地                                         |
| 4           |         -         | DGND        |  -             | 接地                                         |
| 5           | GPIO_A15          | GPIO_A15    |  ◀            | CPU_RSTOUT# : PMIC RSTOUT 控制信号           |
| 6           | GPIO_B10          | GPIO_B10    |  ▶            | CPU_PWR_EN  : CPU_PWR_EN 控制信号            |
| 7           | GPIO_B28          | GPIO_B28    |  ▶            | CPU_SYS_PWR_EN:CPU_SYS_PWR_EN 控制信号       |
| 8           | GPIO_A29          | GPIO_A29    |  ▶            | CPU_RST# : CPU 复位控制                      |
| 9           | GPIO_K10          | GPIO_K10    |  ▶            | CPU_ALIVE_PWR_CTL : ALIVE_PWR 控制信号       |
| 10          | GPIO_K14          | GPIO_K14    |  ▶            | CPU_STR_Module : CPU_STR_Mode 控制           |
| 11          | GPIO_K13          | GPIO_K13    |  ◀            | GPIO 控制信号                                |
| 12          | GPIO_K03          | GPIO_K03    |  ◀            | GPIO 控制信号                                |
| 13          | GPIOA_C09         | SPI0_DO     |  ▶            | SPI 数据输入                                 |
| 14          | GPIOA_C07         | SPI0_CLK    |  ▶            | SPI 时钟                                     |
| 15          | GPIOA_C10         | SPI0_DI     |  ◀            | SPI 数据输出                                 |
| 16          | GPIOA_C08         | SPI0_CS     |  ▶            | SPI 片选                                     |
| 17          |        -          | DGND        |  -             | 接地                                         |
| 18          |        -          | DGND        |  -             | 接地                                         |
| 19          | GPIO_K15          | GPIO_K15    |  ◀            | GPIO 控制信号                                |
| 20          | GPIO_K12          | GPIO_K12    |  ◀            | GPIO 控制信号                                |
| 21          | GPIO_A23          | GPIO_A23    |  ▶            | GPIO 控制信号                                |
| 22          | GPIO_A22          | GPIO_A22    |  ◀            | GPIO 控制信号                                | 
| 23          | GPIO_A20          | UT4_TX      |  ▶            | UART 发送                                    |
| 24          | GPIO_A21          | UT4_RX      |  ◀            | UART 接收                                    |
| 25          | GPIO_B27          | GPIO_B27    |  ◀            | GPIO 控制信号                                |
| 26          | GPIO_K08          | GPIO_K08    |  ▶            | CAN0_TX                                      |                         
| 27          | GPIO_A14          | GPIO_A14    |  ▶            | LCD 背光使能控制                             |
| 28          | GPIO_K01          | GPIO_K01    |  ◀            | CAN0_RX                                      |

<br/>

表 8.2 显示了 J14D1 的引脚说明。 
