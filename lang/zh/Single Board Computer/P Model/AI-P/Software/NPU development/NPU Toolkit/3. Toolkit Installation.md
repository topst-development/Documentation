...
TOPST AI NPU Toolkit 已在安装 Ubuntu 20.04 和 Python 3.8 的 64 位 PC 上
完成测试。不需要 GPU。
...
在安装 python 软件包之前，请确认 python3.8 及相关库
已经安装。TOPST AI NPU Toolkit 所需的 Python 软件包
列在 Toolkit 软件包目录中的 requirements.txt
文件中。
...
<p align="center"><strong>图 3.1 示例网络</strong></p>
