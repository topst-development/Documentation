...
TOPST AI（开放平台开发板）通过与其他开放平台开发板和 TOPST
开发板系列向后兼容的 40 针排针提供 28 个 GPIO
接口。
...
图 1.1 显示了 2.54 mm 间距 40 针 IDC 电缆。
...
alt="显示条纹、织物的图片 自动生成的说明" /></p>

<p align="center"><strong>图 1.1 2.54-mm 间距 40-针 IDC 电缆</strong></p>

图 1.2 显示了 GPIO 排针的 1 号针脚以及如何将 IDC 电缆
连接到 GPIO 排针。
...
alt="显示文本、菜单、屏幕截图、数字的图片 自动生成的说明" /></p>

<p align="center"><strong>图 1.2 GPIO 排针的 1 号针脚</strong></p>

<br/><br/>

## 1.3 GPIO 引脚分配

图 1.3 显示了 GPIO 连接器引脚分布。

所有 GPIO 均可用作输入和输出，部分 GPIO 引脚可以
切换为 I2C、SPI 和 PWM 功能。
...
alt="显示文本、图表、数字、字体的图片 自动生成的说明" /></p>

<p align="center"><strong>图 1.3 GPIO 连接器引脚分布</strong></p>

<br/><br/>

## 1.4 GPIO 备用功能

表 1.1 详细说明了默认引脚功能和可用的 GPIO 备用
功能。
...
<td><p><strong>排针</strong></p>
<p><strong>引脚编号</strong></p></td>
