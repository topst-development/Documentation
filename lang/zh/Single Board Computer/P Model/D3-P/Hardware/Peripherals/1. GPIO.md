...
TOPST D3（开放平台开发板）通过与其他开放平台开发板及 TOPST 开发板系列向后兼容的 40 针排针提供 28 个 GPIO。  

<br/><br/>

## 1.2 GPIO 40 针排针
图 1.1 显示了 2.54 mm 间距 40 针 IDC 排线。  
...
<p align="center"><strong>图 1.1 2.54-mm 间距 40 针 IDC 排线</strong></p>

图 1.2 显示了 GPIO 排针的 1 号引脚以及如何将 IDC 排线连接到 GPIO 排针。  
...
<p align="center"><strong>图 1.2 连接 40 针 GPIO 排针</strong></p>

<br/><br/>

## 1.3 GPIO 引脚分配  

图 1.3 显示了 GPIO 连接器的引脚排列。  
所有 GPIO 均可用作输入和输出，部分 GPIO 引脚可切换为 I2C、I2S、SPI 和 PWM 功能。  
...
<p align="center"><strong>图 1.3 GPIO 连接器引脚排列</strong></p>

引脚图如下所示：
<p align="center"><img src="https://github.com/user-attachments/assets/013c9cf1-cce3-4108-bd44-4bf34379f0de"></p>  
<p align="center"><strong>图 1.4 GPIO 引脚图</strong></p>


表 1.1 详细说明了默认引脚功能以及可用的备用 GPIO 功能。  

**表 1.1 备用 GPIO 功能：**
| GPIO     | 排针引脚编号   | ALT0    | ALT1          | ALT2         | ALT3       | ALT4        | ALT5        | ALT6        |
|:--------:|:--------------:|:-------:|:-------------:|:------------:|:----------:|:-----------:|:-----------:|:-----------:|
