...
TOPST AI NPU Toolkit ได้รับการทดสอบบนเครื่อง PC แบบ 64 บิตที่ใช้ Ubuntu 20.04 และ
Python 3.8 โดยไม่จำเป็นต้องใช้ GPU
...
ไลบรารีที่เกี่ยวข้องแล้ว แพ็กเกจ Python ที่ TOPST AI NPU Toolkit ต้องการ
จะแสดงอยู่ในไฟล์ requirements.txt ภายในไดเรกทอรีของแพ็กเกจ
Toolkit
...
<p align="center"><strong>รูปที่ 3.1 เครือข่ายตัวอย่าง</strong></p>
  ...
  **ตารางที่ 3.2 คำอธิบายเครือข่ายตัวอย่าง:**
