# 2. เซ็นเซอร์ไจโร 9 แกน (MPU9250/GY9250)  
* แหล่งจ่ายไฟ **3V-5V**
* ช่วงการวัดความเร่ง : ±2G, ±4G, ±8G, ±16G
* ช่วงของเซ็นเซอร์ไจโร : ปรับได้ในช่วง ±250 , ±500, ±1000, ±2000 °/sec
* ช่วงการวัดสูงสุดของเซ็นเซอร์สนามแม่เหล็กโลก : ±4800uT

โค้ดต่อไปนี้เป็นโค้ดตัวอย่างสำหรับค่าข้อมูลความเร่ง ไจโร และสนามแม่เหล็กโลก
```
import smbus2
import time
