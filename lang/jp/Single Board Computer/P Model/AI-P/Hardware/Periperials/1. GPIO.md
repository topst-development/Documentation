...
TOPST AI（オープンプラットフォームボード）は、他のオープンプラットフォームボードおよび TOPST
ボードシリーズと下位互換性のある 40 ピンヘッダーを介して 28 個の GPIO を
提供します。
...
alt="縞模様、ファブリックが表示されている写真 自動生成された説明" /></p>

<p align="center"><strong>図 1.1 2.54-mm ピッチ 40-ピン IDC ケーブル</strong></p>

図 1.2 は GPIO ヘッダーの 1 番ピンと、GPIO ヘッダーに IDC ケーブルを
接続する方法を示します。
...
alt="テキスト、メニュー、スクリーンショット、番号が表示されている写真 自動生成された説明" /></p>

<p align="center"><strong>図 1.2 GPIO ヘッダーの 1 番ピン</strong></p>

<br/><br/>

## 1.3 GPIO ピン割り当て

図 1.3 は GPIO コネクタのピン配置を示します。

すべての GPIO は入力および出力として使用でき、一部の GPIO ピンは
I2C、SPI、PWM として機能するよう切り替えることができます。
...
alt="テキスト、図表、番号、フォントが表示されている写真 自動生成された説明" /></p>

<p align="center"><strong>図 1.3 GPIO コネクタのピン配置</strong></p>

<br/><br/>

## 1.4 GPIO 代替機能

表 1.1 に、デフォルトのピン機能と使用可能な GPIO 代替機能を
詳細に示します。
...
<td><p><strong>ヘッダー</strong></p>
<p><strong>ピン番号</strong></p></td>
