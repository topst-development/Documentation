...
TOPST AI NPU Toolkit は、Ubuntu 20.04 および Python 3.8 環境の 64 ビット PC で
テストされました。GPU は必要ありません。

<br/><br/>

## 3.1 パッケージのインストール

python パッケージをインストールする前に、python3.8 および関連ライブラリが
インストールされていることを確認してください。TOPST AI NPU Toolkit に必要な
Python パッケージは、Toolkit パッケージディレクトリ内の requirements.txt
ファイルに記載されています。
...
<p align="center"><strong>図 3.1 サンプルネットワーク</strong></p>
