...
1.  TOPST AI ボードを起動します。
2.  “scp” コマンドを使用して Network フォルダを転送します。
...
<p align="center"><strong>図 6.1 scp コマンド</strong></p>

3.  TOPST AI コンソールで以下のとおり確認します。
...
<p align="center"><strong>図 6.2 ダウンロードの確認</strong></p>

4.  TOPST AI コンソールで以下のコマンドを入力すると、サンプル
    アプリケーションが実行されます。
...
<p align="center"><strong>図 6.3 サンプルアプリケーションの実行画面</strong></p>
